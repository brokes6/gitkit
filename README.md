...
第一次 `npm run tauri dev` 会下载并编译 Rust 依赖,耗时较久属正常。窗口起来后即是原生 App
...
- [x] 3. 写操作:Push / Fetch / Merge / Cherry-pick / 暂存与提交 / 创建 MR
- [x] 4. 多套提交者身份(设置里维护,项目级切换)
- [x] 5. 自建 GitLab 集成(Token 存 Keychain,创建 MR)
